	...
	<tbody valign="top">
		<tr>
			<td style="text-align: center">
				<img src="<?php echo JURI::root() ?>media/com_<?php echo $this->name ?>/images/splash.png" alt="<?php echo JText::_('Extension logo') ?>" title="<?php echo JText::_('Extension logo') ?>" /><br /><br /><div class="button2-left" style="margin-left: 20px;" ><div class="blank"><a href="<?php echo JRoute::_('&option='.$extname.'&view=dashboard') ?>"><?php echo JText::_('Harbour dashboard'); ?></a></div></div>
			</td>
			<td width="100%">
				<table class="adminlist">
					<thead>
						<tr>
							<th><?php echo JText::_('System') ?></th>
							<th width="35%"><?php echo JText::_('Status') ?></th>
						</tr>
					</thead>
					<tfoot>
						<tr>
							<td colspan="5"><div id="install" style="font-weight: normal; padding-left: 195px" <?php if(!$packages) echo 'style="display: none"' ?> class="<?php echo $class ?>"><h5 class="working"><?php echo JText::_('Please wait, checking for additional packages to install'); ?></h5></div></td>
						</tr>
					</tfoot>
					<tbody id="tasks">
